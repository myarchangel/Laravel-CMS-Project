  ...
  <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          {{-- <ul class="navbar-nav navbar-right">
            <li class="nav-item"><a class="nav-link" href="/lsapp/public/posts/create">Create Post</a></li>
          ...
          <ul class="navbar-nav ml-auto">
              ...
              @else
                  ...
                  <li class="nav-item"><a class="nav-link" href="/lsapp/public/dashboard">{{ __('Dashboard') }}</a></li>
              @endguest
          </ul>
      </div>
  </div>
